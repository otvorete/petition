...
Справка: според Закона за електронното управление (чл. 58а, т. 1), компютърните програми трябва да отговарят на критериите за софтуер с отворен код, вижте [тук](https://www.lex.bg/laws/ldoc/2135555445). Настоящата петиция призовава за спазването на закона и за разширяване на обхвата му.
